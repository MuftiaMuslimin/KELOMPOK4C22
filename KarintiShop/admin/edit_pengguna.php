    ...
    <section id="contact" class="contact">
        <div class="row">
            <form action="" method="POST">
                <div class="inputBox">
                    <input value="<?= $pengguna['username']; ?>" type="text" name="username"
                        placeholder="enter your username" class="box" style="width: 100%;">
                </div>
                <div class="inputBox">
                    <input value="<?= $pengguna['password']; ?>" type="password" name="password"
                        placeholder="enter your password" class="box" style="width: 100%;">
                </div>
